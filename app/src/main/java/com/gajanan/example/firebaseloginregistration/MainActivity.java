package com.gajanan.example.firebaseloginregistration;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeEmail = (Button) findViewById(R.id.btn_changeEmail);
        ...
        oldEmail = (EditText) findViewById(R.id.edt_old_email);
        newEmail = (EditText) findViewById(R.id.edt_new_email);
        password = (EditText) findViewById(R.id.edt_password);
        newPassword = (EditText) findViewById(R.id.edt_newPassword);
